                        ...
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th style="width: 8%; text-align: center;">ยอดจ่าย</th>
                            ...
                            <tbody>
                                <tr ng-repeat="(index, approvement) in approvements">
                                    ...
                                    <td style="text-align: center;">@{{ approvement.net_total | number: 2 }}</td>
                                    <td style="text-align: center;">@{{ approvement.app_stat }}</td>
                                    <td style="text-align: center;">
                                        <a ng-click="edit(approvement.supplier_id)" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>

                                        @if(Auth::user()->person_id == '1300200009261')

                                            <a ng-click="delete(approvement.supplier_id)" class="btn btn-danger btn-sm">
